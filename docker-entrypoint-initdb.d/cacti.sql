...
--
-- FIX for MYSQL TimeZone
--

GRANT SELECT ON mysql.time_zone_name TO cacti@'docker-cacti' IDENTIFIED BY 'cacti';
GRANT SELECT ON mysql.time_zone_name TO cacti@'localhost' IDENTIFIED BY 'cacti';
GRANT SELECT ON mysql.time_zone_name TO cacti@'%' IDENTIFIED BY 'cacti';
